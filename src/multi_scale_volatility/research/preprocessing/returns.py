...
from multi_scale_volatility.core.config.names import LOG_RETURN, PREVIOUS_TIMESTAMP_UTC, TIMESTAMP_UTC
from multi_scale_volatility.research.preprocessing.summary import int_key_counts
from multi_scale_volatility.core.io import json_scalar
...
def _dropped_returns_for_report(dropped: pd.DataFrame) -> list[dict[str, Any]]:
    ...
    for record in rows.to_dict("records"):
        records.append({key: json_scalar(value)
