...
from src.scale_utils import compress_component
from src.stats import autocorrelation, compressed_layer_autocorrelation
...
def plot_layer_acf_grid(
    ...
    for axis, layer in zip(axes, layers):
        ...
        axis.plot(shuffle_lags, shuffle_acf, linewidth=0.9, label="Shuffled", alpha=0.9)
        axis.plot(gaussian_lags, gaussian_acf, linewidth=0.9, label="Gaussian", alpha=0.9)
